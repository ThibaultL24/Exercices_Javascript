const entrepreneurs = [
  ...
  console.log("2. Prénoms et noms des entrepreneurs :");
  const prenomsNomsEntrepreneurs = entrepreneurs.map(entrepreneur => ({ first: entrepreneur.first, last: entrepreneur.last }));
  console.log(prenomsNomsEntrepreneurs);
  
  console.log("3. Âge actuel des inventeurs :");
  const ageActuel = entrepreneurs.map(entrepreneur => ({ first: entrepreneur.first, last: entrepreneur.last, age: new Date().getFullYear() - entrepreneur.year }));
